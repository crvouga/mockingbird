...
export const PSC_AVAILABILITY_ZIPS = [
  "85004",
  "85234",
  "11050",
  "10006",
 ...
 */
export const PHLEBOTOMY_AVAILABILITY_ZIPS = ["85004"] as const
...
/**
 * Curated real ZIPs used as this package's parity coverage corpus (one per US state plus DC,
 * plus scheduling pins). Prefetched into the observation cache so area/PSC parity is sealed
 * for those geos.
 */
...
/** Lab ids exercised by walk-in / PSC parity flows (quest, labcorp, bioreference, sonora). */
export const PSC_LAB_IDS = [4, 6, 13, 25] as const
