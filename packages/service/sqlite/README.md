...
> Formerly [`@crvouga/sqlite-mem`](https://www.npmjs.com/package/@crvouga/sqlite-mem) ([archived repo](https://github.com/crvouga/sqlite-mem)). Migrate by replacing the package name; the API is unchanged.
